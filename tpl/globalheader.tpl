			...
			<div>
				<ul id="nav" class="menubar">
					{if $LoggedIn}
							...
							<li class="menubaritem"><a href="#">{translate key=ApplicationManagement}</a>
								<ul>
									...
									<li class="menuitem"><a
										...
										<ul>
											<li class="menuitem"><a
														href="{$Path}admin/manage_resource_groups.php">{translate key="ManageGroups"}</a>
											</li>
											<li class="menuitem"><a
									...
									<li class="menuitem"><a href="#">{translate key="Import"}</a>
										<ul>
											<li class="menuitem"><a href="{$Path}admin/ics_import.php">{translate key="ImportICS"}</a></li>
											<li class="menuitem"><a href="{$Path}admin/quartzy_import.php">{translate key="ImportQuartzy"}</a></li>
										</ul>
									</li>
									<li class="menuitem"><a
						...
						{/if}
						{if $CanViewReports}
							<li class="menubaritem"><a
										href="{$Path}reports/{Pages::REPORTS_GENERATE}">{translate key=Reports}</a>
								<ul>
									<li>
