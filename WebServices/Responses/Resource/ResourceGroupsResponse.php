...
class ExampleResourceGroupsResponse extends ResourceGroupsResponse
{
	public function __construct()
	{
		...
		$group->AddResource(new ResourceGroupAssignment(0, 'Resource 1', 1, null, 2, ResourceStatus::AVAILABLE, null));
		$group2->AddResource(new ResourceGroupAssignment(1, 'Resource 2', 1, null, 2, ResourceStatus::AVAILABLE, null));
